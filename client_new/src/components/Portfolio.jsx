    ...
    <div>
      ...
      <header id="head">
        <nav id="navbar">
          ...
          <a href="#contact"><h1 className="nav-item">Contact</h1></a>
          <a href="#project"><h1 className="nav-item">Projects</h1></a>
          <a href="#intern"><h1 className="nav-item">Internships</h1></a>
          <a href="#technical-container"><h1 className="nav-item">Skills</h1></a>
          <a href="#aboutme"><h1 className="nav-item">About</h1></a>
        </nav>
      </header>
        ...
        <section id="project">
          ...
          <div id="container">
            ...
            <div id="box1">
              ...
              <h4 id="p">A Task Manager is a tool that helps users create, track, edit, and organize tasks efficiently, improving productivity. It typically includes features like task prioritization, deadlines, status tracking, and collaboration options.
            ...
            <div id="box1">
              ...
              <h4 id="p">A live web application for round-robin coupon distribution with abuse prevention, ensuring fair allocation through IP and cookie tracking while allowing guest access and providing user feedback.
          ...
          <div id="tech-item-hidden">
            {[
              ...
              <div className="skill" key={index}>
                <div className="progress-circle" style={{ background: `conic-gradient(#007bff ${item.percent}%, white ${item.percent}%)` }}>
                  {item.percent}%
                </div>
...
const TechnicalSkills = () => {
  ...
  const handleMouseEnter = (index, percent) => {
    ...
    // Animate the progress over 0.2s
    setTimeout(() => {
        ...
        {skills.map((item, index) => (
          ...
          >
            <div
              ...
              style={{
                transition: "background 0.2s ease-in-out", // 0.2s transition speed
