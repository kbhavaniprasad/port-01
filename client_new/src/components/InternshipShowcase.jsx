...
const internships = [
  {
    ...
    period: '24 June 2024 – 20 July 2024',
    description:'Completed a 4-week internship at Biztron Softech focused on MERN Stack development. Gained hands-on experience in building full-stack web applications using MongoDB, Express.js, React.js, and Node.js, along with REST API integration and responsive UI development. Collaborated with the engineering team to implement new features, optimize performance, and enhance user experience. Contributed to code reviews, debugging, and testing processes, resulting in a successful project delivery that met client requirements.',
  ...
  },
  {
    ...
    description:
      'Completed a 6-month internship in Artificial Intelligence & Machine Learning through SmartBridge Educational Services in collaboration with APSCHE. Gained hands-on experience in data preprocessing, building and training Machine Learning and Deep Learning models, model evaluation, and real-world problem-solving using Python, TensorFlow, Scikit-learn, and AI/ML frameworks.',
  ...
  },
  {
    ...
    description:
      'Completed a Salesforce Developer internship focused on developing dynamic web applications using Lightning Web Components (LWC) and implementing backend business logic with Apex. Worked on automating business workflows, managing data operations, and enhancing CRM functionalities using Salesforce platform tools and cloud-based development practices.',
